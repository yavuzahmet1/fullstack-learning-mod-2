...
const MovieDetail = () => {
  ...
  useEffect(() => {
    axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=${API_KEY}`).then((movie) => setDetail(movie.data))
  }, [])
  console.log(detail)
        ...
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-100 shadow-lg">
          ...
          <div className="p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-700 text-base mb-4">{detail.overview}</p>
            </div>
